...
import { PrePrimaryPage, PrimaryPage, MiddleCollegePage } from './pages/academics'
...
app.get('/academics/pre-primary', (c) => {
    return c.html(Layout(PrePrimaryPage(), 'Undergraduate Programs', 'academics-pre-primary'))
})

app.get('/academics/primary', (c) => {
    return c.html(Layout(PrimaryPage(), 'Postgraduate Programs', 'academics-primary'))
})

app.get('/academics/middle', (c) => {
    return c.html(Layout(MiddleCollegePage(), 'Middle College Education', 'academics-middle'))
})
...
app.get('/academics/secondary', (c) => {
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        Final Year and Research focus on academic excellence, board exam preparation, and university readiness. Students receive comprehensive support for Semester and Final Exams, competitive entrance exams, and international university applications.
                    </p>
                ...
                <div class="bg-green-50 rounded-2xl p-8">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Board Exam Excellence (UG & PG)</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-green-600 mt-1 mr-3"></i>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 shadow-lg text-center">
                    ...
                    <div class="text-2xl font-bold text-gray-900 mb-2">Final Year Pass Rate</div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 shadow-lg text-center">
                    ...
                    <div class="text-2xl font-bold text-gray-900 mb-2">Final YearII Pass Rate</div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <p class="text-sm text-gray-600">Intensive preparation for UG & PG board exams</p>
                </div>
    ...
    <section class="py-16 bg-gradient-to-r from-green-500 to-emerald-500 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-4xl font-bold mb-6">Shape Your Future at Dr. SNS Rajalakshmi College of Arts and Science</h2>
            <p class="text-xl mb-8 opacity-90">
                Join India's first GenAI-powered Design Thinking Autonomous College and prepare for excellence in board exams and beyond.
            </p>
  ...
  `;
    return c.html(Layout(content, 'Research & Ph.D. Programs', 'academics-secondary'))
})
